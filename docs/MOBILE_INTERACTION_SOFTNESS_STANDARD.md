...
------------------------------------------------------------
VII. Accent Discipline (Delta-Specific, Strict)

Electric blue #00B7F4 is a signal color, not a decoration color.
...
If the eye does not clearly land on a single focal point,
the accent system is broken.

Enforcement Rule

If unsure whether to use blue:
Use grayscale.

Only escalate to accent when:
Removing it would reduce clarity of the primary action.
